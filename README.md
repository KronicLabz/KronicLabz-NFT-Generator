![](https://github.com/KronicLabz/KronicLabz-NFT-Generator/blob/main/logo.png)

![](https://github.com/KronicLabz/KronicLabz-NFT-Generator/blob/main/banner.png)
...
```sh
git clone https://github.com/KronicLabz/KronicLabz-NFT-Generator.git
```
...
```json
{
  ...
  "image": "https://KronicKatz/nft/1.png",
  "edition": 1,
  "date": 1731990799975,
  "attributes": [
  ...
  "compiler": "KronicLabz NFT Generator"
}
```
